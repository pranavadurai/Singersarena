...
(function() {
  ...
  get_message = function() {
    var con_id, messages, messages_to_bottom;
    messages = $('#messages');
    con_id = $('#messages').data('conversation-id');
    console.log($('#messages').data('conversation-id'));
...
(function() {
  ...
  $(function() {
    return $(document).on('click', '.play', function() {
      ...
      return $(this).parent().html('<div class="pause" data-player-id ="' + id + '"><i class="fa fa-pause-circle fa-3x"></i></div>');
    });
  });
  ...
  $(function() {
    return $(document).on('click', '.pause', function() {
      ...
      return $(this).parent().html('<div class="play" data-player-id ="' + id + '"><i class="fa fa-play-circle fa-3x"></i></div>');
    });
  });
