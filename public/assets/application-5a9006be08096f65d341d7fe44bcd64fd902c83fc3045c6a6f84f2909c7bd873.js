...
(function() {
  ...
  $(function() {
    $('#forget_password').on("ajax:success", function(e, data, status, xhr) {
      return $('#password_reset_msg').html(data);
  ...
  $(document).on('click', '.like_unlike', function() {
    ...
    return $.ajax(url, {
      ...
      success: function(data, textStatus, jqXHR) {
        ...
        return $('#like_block' + song_id).append(data);
      }
    });
  });
...
(function() {
  $(function() {
    $(document).on('click', '#followers', function() {
      return $('#user_show_page_container').html("<%= escape_javascript(render('users/followers')) %>");
    });
    $(document).on('click', '#followeds', function() {
      return $('#user_show_page_container').html("<%= j render('users/following') %>");
    });
    return $(document).on('click', '#my_songs', function() {
      return $('#user_show_page_container').html("<%= j render('users/songshow') %>");
    });
  });
